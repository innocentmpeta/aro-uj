...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { key: 'home_workpackages', label: 'Work packages grid',      description: 'The 10 WP cards — replaces the old Five Themes section' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'about_kuleuven',    label: 'KU Leuven section',     description: 'The international partnership section' },
      { key: 'about_partners',    label: 'Partners & funders',    description: 'The partners grid' },
    ]
  },
  {
